...
df1 = pd.read_excel("G:\\AdaSGD-D\\compare_cifar10\\cifar10_adam.xlsx")
df2 = pd.read_excel("G:\\AdaSGD-D\\compare_cifar10\\cifar10_momentum.xlsx")
df3 = pd.read_excel("G:\\AdaSGD-D\\compare_cifar10\\cifar10_pid.xlsx")
...
def plt_curve(objective):
    ...
    plt.savefig('G:\\AdaSGD-D\\compare_cifar10\\'+ objective+'.jpg',dpi=300,bbox_inches='tight')
    clf()
    time.sleep(3)
